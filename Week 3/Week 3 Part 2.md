...
т.е. под `#include<iostream>` да напишете и 
`#include<windows.h>`
...
За да генерирате произволно число от 1 до 100 може да ползвате rand() % 100. Функцията
rand() ще може да ползвате след като include-нете cstdlib.
...
Напишете функция, която проверява дали едно число е палиндром. Едно число е палиндром ако числото, образувано
от цифрите му в обратен ред, е равно на даденото. Примери: 
* 0, 1, 2, .... 9 са палиндроми;
* 10 не е палиндром
* 11 е палиндром
* 31 не е палиндром
* 121 е палиндром
